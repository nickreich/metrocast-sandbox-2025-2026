...
intermediate_path <- "intermediate-output/model-output"
model_name = "UMass-AR6_thetaP"
...
output_dir <- paste0("../../model-output/", model_name)
...
utils::write.csv(
  ...
  file = file.path(
    output_dir,
    paste0(reference_date, "-", model_name, ".csv")
  ),
  row.names = FALSE
)
